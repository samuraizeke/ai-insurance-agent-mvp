...
export default function Chat() {
  ...
  const [policyCard, setPolicyCard] = useState<any>(null);
    ...
    <div className="flex h-[80vh] flex-col md:h-[85vh]">
      ...
      <div className="relative flex-1 overflow-y-auto p-4 md:p-6">
        <div className="mx-auto flex max-w-3xl flex-col gap-4">
          {messages.length === 0 && (
            <div className="mx-auto mt-10 rounded-full border border-[var(--color-muted)] bg-[var(--color-warm)]/40 px-4 py-2 text-xs text-[var(--color-ink-2)]">
              Start a conversation to get instant answers about coverage, policies, and quotes.
            </div>
          )}
